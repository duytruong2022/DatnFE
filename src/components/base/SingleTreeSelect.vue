<template>
    <div class="form-group flex-column">
        ...
        <el-tree-select
            ...
            :file-node-method="filterNodeMethod"
            :check-strictly="checkStricky"
            :clearable="clearable"
            :data="options"
            :lazy="lazy"
            :load="load"
...
export default class SingleTreeSelect extends Vue {
    ...
    @Prop({ default: {} }) readonly props?: Record<string, unknown>;
    @Prop({ default: false }) readonly lazy?: boolean;
    @Prop({ default: false }) readonly checkStricky?: boolean;
    @Prop({ default: false }) readonly defaultExpandAll?: boolean;
    @Prop({ default: null }) readonly load?: (node: any, resolve: any) => void;
    @Prop({ default: null }) readonly filterNodeMethod?: (value: any, data: any) => void;
