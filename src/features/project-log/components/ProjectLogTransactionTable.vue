...
export default class ProjectLogTransactionTable extends mixins(ProjectLogMixins) {
    get projectLogList() {
        return projectLogModule.projectLogTransactionList.map((projectLog) =>
            this.parseProjectLogValue(projectLog),
        );
    }

    get totalItems(): number {
        return projectLogModule.totalProjectLogTransactions;
    }
