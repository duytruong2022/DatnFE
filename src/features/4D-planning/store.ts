...
class ProjectPlanningModule extends VuexModule {
    initialGridSettingParams = {
        displayingStatus: {
            ...
            blFinish: false,
            prConstraint: false,
            prConstraintDate: false,
            expectedFinish: false,
            durationType: false,
            originalDuration: false,
            actualDuration: false,
            remainingDuration: false,
            plannedDuration: false,
            atCompleteDuration: false,
            blDuration: false,
            VBLDuration: false,
            VBLFinishDate: false,
            VBLStartDate: false,
            ...
            totalFloat: false,
            critical: false,
            percentCompleteType: false,
            physicalPercentage: false,
            durationPercentage: false,
            manualPercentage: false,
            physicalUnit: false,
            physicalQuantity: false,
            actualPhysicalQuantity: false,
            remainPhysicalQuantity: false,
            rules: false,
            appearanceProfile: false,
            resouce3D: false,
            resourceGroup: false,
            activityCode: false,
